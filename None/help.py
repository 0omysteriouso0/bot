...
class Help(commands.Cog):
    ...
    async def newhelp(self, ctx, *input):
	...
	# setting owner name - if you don't wanna be mentioned remove line 49-60 and adjust help text (line 88) 
        ...
        if not input:
            ...
            emb = discord.Embed(title='Commands and modules', color=0xffdd00,
                                description=f'Use `{prefix}help <module>` to gain more information about that module '+f':smiley:\n')
